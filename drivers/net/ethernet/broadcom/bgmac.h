...
#define	 MAC_SPEED_SHIFT			0
#define	 MAC_SPEED_MASK				GENMASK(1, 0)
#define	 MAC_SPEED(mode)	(((mode) >> MAC_SPEED_SHIFT) & MAC_SPEED_MASK)
#define	 MAC_DUPLEX_SHIFT			2
#define	 MAC_DUPLEX				BIT(MAC_DUPLEX_SHIFT)
#define	 MAC_RX_PAUSE_SHIFT			3
#define	 MAC_RX_PAUSE				BIT(MAC_RX_PAUSE_SHIFT)
#define	 MAC_TX_PAUSE_SHIFT			4
#define	 MAC_TX_PAUSE				BIT(MAC_TX_PAUSE_SHIFT)
#define	 MAC_LINK_STAT_SHIFT			5
#define	 MAC_LINK_STAT				BIT(MAC_LINK_STAT_SHIFT)
...
#define ETHER_MAX_LEN_JUMBO	9720
#define BGMAC_RX_JUMBO_FRAME_SIZE	(ETHER_MAX_LEN_JUMBO + ETHER_HDR_LEN + \
					ETHER_FCS_LEN)
#define BGMAC_RX_JUMBO_BUF_SIZE		(BGMAC_RX_FRAME_OFFSET + \
					 BGMAC_RX_JUMBO_FRAME_SIZE)
#define BGMAC_RX_ALLOC_JUMBO_SIZE	(SKB_DATA_ALIGN(\
						BGMAC_RX_JUMBO_BUF_SIZE + \
						BGMAC_RX_BUF_OFFSET) + \
					 SKB_DATA_ALIGN(\
...
#define BCM_AMAC_NSP_CONFIG	0xFEFEFEFE
#define BCM_AMAC_CONFIG		0x00000000
#define BCM_AMAC_NS2_CONFIG	0x00000000
#define BCM_AMAC_NS2_A0_CONFIG	0x00000000
...
#define BGMAC_JUMBO_FRAME_SUPPORT	BIT(16)
#define BGMAC_FEAT_CRC_STRIP		BIT(17)
#define BGMAC_FEAT_OOB_FC		BIT(18)
...
struct bgmac {
	...
	struct bgmac_rx_stats rx_stats;
	struct bgmac_tx_stats tx_stats;
...
#ifndef of_phy_get_and_connect
#include <linux/of_mdio.h>
#include <linux/of_net.h>

static inline struct phy_device *of_phy_get_and_connect(struct net_device *dev,
