...
int eagle_phy_interface_config_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_phy_inf_config_t* config)
{
    ...
    */
    PHYMOD_IF_ERR_RETURN
      (eagle_tsc_get_vco(config, &vco_rate,(uint32_t *)&new_pll_div, &new_os_mode));
...
*/
    ...
    */
    ...
    /* FIXME clean the interface, no need for interface */
...
*/
        ...
        /*FIXME, need a function to get the starting lane number based on the lane_map*/
        /*
        PHYMOD_IF_ERR_RETURN
