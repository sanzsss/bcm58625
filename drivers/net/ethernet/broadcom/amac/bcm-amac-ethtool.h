...
int bcm_ethtool_get_settings(struct net_device *ndev, struct ethtool_cmd *cmd);
int bcm_ethtool_set_settings(struct net_device *ndev, struct ethtool_cmd *cmd);
void bcm_ethtool_get_drvinfo(struct net_device *ndev,
			     struct ethtool_drvinfo *info);
int bcm_ethtool_nway_reset(struct net_device *ndev);
void bcm_ethtool_get_strings(struct net_device *ndev, u32 stringset, u8 *buf);
