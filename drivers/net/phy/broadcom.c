...
static int bcm95xx_config_init(struct phy_device *phydev)
{
	/* Needed to select Analog pll control 3 to 0x0a0 */
	phy_write(phydev, MII_BCM54XX_EXP_SEL, EGPHY28_PLL_CONTROL3_REG);
	phy_write(phydev, MII_BCM54XX_EXP_DATA, EGPHY28_PLL_CONTROL3_VALUE);
...
static struct phy_driver broadcom_drivers[] = {
{
	...
	.phy_id         = PHY_ID_BCMEGPHY28,
	.phy_id_mask    = 0xfffffff0,
	.name           = "Broadcom EGPHY28",
	.features       = PHY_GBIT_FEATURES |
			  SUPPORTED_Pause | SUPPORTED_Asym_Pause,
	.flags          = PHY_IS_INTERNAL,
	.config_init    = bcm95xx_config_init,
	.config_aneg    = genphy_config_aneg,
	.read_status    = genphy_read_status,
}, {
